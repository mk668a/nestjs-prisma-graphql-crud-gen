...
import { NestedEnumUserRoleWithAggregatesFilter } from "./NestedEnumUserRoleWithAggregatesFilter.input";
import { NestedIntFilter } from "./NestedIntFilter.input";

@NestJsGraphQL.InputType('EnumUserRoleWithAggregatesFilter', { isAbstract: true })
